...
with open('../data-synthesis/3Denvs/LLaMA3_Inst_few-shot-prompts.txt', 'r') as f:
    prompt = f.read()
...
for i in range(len(eng)):
    try:
        prompt_ = f"""{prompt}  
Task: {eng[i]['nl_description']}<|eot_id|><|start_header_id|>assistant<|end_header_id|>
"""
        #print("Prompt piece")
        #print(prompt)
        #print("Complete feed")
...
with open('results_instruction_tuned_LLaMA.json', 'w') as fo:
