# THIS WILL HELP US GENERATE PROMPTS
import json
...
# Just get a count of the obstacles in our world
...
# Just get a count of the goals in our world
    ...
    for i in range(len(world)):
        for j in range(len(world[i])):
            if(world[i][j]==3):
                cnt += 1
    return cnt
# '../single_goal/6x6worlds/train_set.json'
# Get the training set
with open('1_train_set_samples.json') as f:
    data = json.load(f)
...
## TODO: get the dev set working, but lol I don't think this is ever used
#with open('1dev_set.json') as f:
#    data = json.load(f)
#        
#    for instance in data:
...
# Why is this hard coded to 3, who knows
